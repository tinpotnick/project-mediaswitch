...
Like project-sip, this has a http interface for other components to talk to it with. There is also a version written in JS for Node which is documented here also.
