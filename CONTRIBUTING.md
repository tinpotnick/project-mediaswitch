# Contributing to Project Mediaswitch

:+1::tada: First off, thanks for taking the time to contribute. :tada::+1:

We are hoping to build a community of like minded people who are looking to help build this great software.

# Process

1. Please open a request to highlight the pull request
2. Update any documentation to reflect the change if required
